...
class CreateProfile2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.btn_man.addShadow(offset: CGSize(width: 1.0, height: 1.0), color: .gray, radius: 5.0, opacity: 0.5)
        self.btn_woman.addShadow(offset: CGSize(width: 1.0, height: 1.0), color: .gray, radius: 5.0, opacity: 0.5)
